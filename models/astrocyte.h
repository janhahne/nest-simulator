...
Name: astrocyte - Hodgkin-Huxley neuron model with gap-junction support.

Description:

astrocyte is an implementation of a spiking neuron using the
...
*/
class astrocyte : public Archiving_Node
{
